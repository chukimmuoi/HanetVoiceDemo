package learn.chukimmuoi.com.hanetvoicedemo.constanst;
...
public interface IConstanst {
    public static final String LANGUAGES_VI = "vi-VN";
    public static final int MAX_RESULTS_VOID_SEARCH = 1;
    ...
    public static final int EXTRA_SPEECH_INPUT_MINIMUM_LENGTH_MILLIS = 60 * 1000;
}
